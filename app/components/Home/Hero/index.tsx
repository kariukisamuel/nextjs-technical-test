      ...
      <div className="relative bg-gradient-to-r from-blazingRed  to-blazingYellow h-[85vh] md:h-screen">
        <div className="h-full">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl text-white uppercase  font-bold leading-normal mb-4 font-montserrat opacity-0">
              Share Your <br></br>
              Holiday Dream
            </h1>
            {/* Render the hero section description with appropriate styling */}
            <p className="text-xl md:text-2xl text-lightAlmond mb-8 font-roboto opacity-0 ">
